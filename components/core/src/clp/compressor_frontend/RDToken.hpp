#ifndef COMPRESSOR_FRONTEND_RDTOKEN_HPP
#define COMPRESSOR_FRONTEND_RDTOKEN_HPP
...
namespace compressor_frontend {
    ...
    public:
        // Constructor
        RDToken () : m_buffer(nullptr), m_buffer_size(0), m_type_ids_ptr(nullptr), m_start_pos(0),
                   m_end_pos(0), m_line(0) {} //, m_type_ids_set() {}

        // Constructor
        RDToken (uint32_t start_pos, uint32_t end_pos, const char* buffer, uint32_t buffer_size,
