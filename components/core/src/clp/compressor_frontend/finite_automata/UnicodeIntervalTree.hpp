...
private:
    ...
    public:
        ...
        pop(std::unique_ptr<Node> node, Interval interval, std::unique_ptr<Node>* ret);
         ...
         */
        static std::unique_ptr<Node>
        pop_min(std::unique_ptr<Node> node, std::unique_ptr<Node>* ret);
        ...
        Interval get_interval() { return m_interval; }
