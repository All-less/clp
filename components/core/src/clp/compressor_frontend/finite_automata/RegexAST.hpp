...
public:
     ...
     */
    [[nodiscard]] RegexASTLiteral* clone() const override { return new RegexASTLiteral(*this); }
    ...
    [[nodiscard]] uint32_t const& get_character() const { return m_character; }
...
public:
     ...
     */
    [[nodiscard]] RegexASTInteger* clone() const override { return new RegexASTInteger(*this); }
    ...
    [[nodiscard]] std::vector<uint32_t> const& get_digits() const { return m_digits; }

    [[nodiscard]] uint32_t const& get_digit(uint32_t i) const { return m_digits[i]; }
...
public:
     ...
     */
    [[nodiscard]] RegexASTGroup* clone() const override { return new RegexASTGroup(*this); }
    ...
    void add_range(uint32_t min, uint32_t max) { m_ranges.emplace_back(min, max); }

    void add_literal(uint32_t literal) { m_ranges.emplace_back(literal, literal); }

    void set_is_wildcard_true() { m_is_wildcard = true; }
...
private:
     ...
     */
    static std::vector<Range> merge(std::vector<Range> const& ranges);
     ...
     * @return std::vector<Range>
     */
    static std::vector<Range> complement(std::vector<Range> const& ranges);
...
public:
     ...
     * @return RegexASTOr*
     */
    [[nodiscard]] RegexASTOr* clone() const override { return new RegexASTOr(*this); }
...
public:
     ...
     * @return RegexASTCat*
     */
    [[nodiscard]] RegexASTCat* clone() const override { return new RegexASTCat(*this); }
...
public:
    ...
    [[nodiscard]] bool is_infinite() const { return this->m_max == 0; }
